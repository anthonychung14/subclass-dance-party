...
*/
var PositionDancer = function(top, left, timeBetweenSteps){
  Dancer.call(this, top, left, timeBetweenSteps);
  this.state = true;
};
PositionDancer.prototype = Object.create(Dancer.prototype)

PositionDancer.prototype.constructor = PositionDancer;
PositionDancer.prototype.step = function(){
